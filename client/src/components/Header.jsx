...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto 
        mt-10 text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        {Array(6)
          ...
          .map((item, index) => (
            ...
            cursor-pointer max-sm:w-10"
              src={index % 2 === 0 ? assets.sample_img1 : assets.sample_img2}
              alt=""
              key={index}
              width={70}
            />
      ...
      className="mt-2 text-neutral-600">Generated images from Artova</motion.p>
    </motion.div>
  );
};
